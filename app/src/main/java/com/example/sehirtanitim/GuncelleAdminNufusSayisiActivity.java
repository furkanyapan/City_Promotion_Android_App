    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGuncelle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sorgu = "UPDATE Tablo SET ilce_name='"+edtIlceAdi.getText().toString()+"',nufus_2021='"+edt2021.getText().toString()+"',nufus_2022='"+edt2022.getText().toString()+"',nufus_2023='"+edt2023.getText().toString()+"' WHERE nufus_id='"+idisi+"'";
                try {
                    db.execSQL(sorgu);
